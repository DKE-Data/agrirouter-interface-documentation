...
When link:/docs/integration/messageSending.adoc[sending messages], the result will be link:docs/integration/messageReceiving.adoc[received through the outbox] and can be link:./docs/integration/analysemessage.adoc[analyzed] depending on the link:/docs/tmt.adoc[technical message type] and the link:./docs/resultCodes.adoc[resultCodes].