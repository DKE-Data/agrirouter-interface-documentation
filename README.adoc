...
Every AppInstance can link:./docs/integration/message-sending.adoc[send messages] and commands the same way.
...
Command results and messages from other endpoints will be link:./docs/integration/message-receiving.adoc[received through the outbox] by the receiving AppInstance.

Messages from other endpoints are put into the outbox by link:./docs/integration/message-pushing.adoc[Push Notifications] as well as by link:./docs/commands/feed[requesting the feed content].
