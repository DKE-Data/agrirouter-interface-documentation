...
When link:./docs/integration/message-sending.adoc[sending messages], the result will be link:./docs/integration/message-receiving.adoc[received through the outbox].
