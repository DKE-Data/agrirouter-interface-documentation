...
Every AppInstance can send messages and commands the same way.
...
When link:./docs/integration/message-sending.adoc[sending messages], they will be link:./docs/integration/message-receiving.adoc[received through the outbox] by the receiving AppInstance.
Additionally, link:./docs/integration/message-pushing.adoc[Push Notifications] will be delivered through the outbox.
