...
To integrate your application with the agrirouter, it's important to understand the link:./docs/concepts.adoc[general concepts].
...
When developing a telemetry platform, the link:./docs/telemetry-platform-concept.adoc[concepts of a telemetry platform] should be understood.
