...
| VAL_000309   | Cannot offboard virtualized application            | VCU Onboarding                       | Error     | VCU could not be offboarded because it doesn't exist or because of any other error | CLOUD_REGISTRATIONS
|===
