...
[NOTE]
====
There is only *one* developer account needed *per company*. Testing the app, especially in the Quality assurance environment can and should be done from ordinary end user accounts.
====
