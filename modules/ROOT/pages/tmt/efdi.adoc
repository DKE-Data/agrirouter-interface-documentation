...
|Protobuf Schema |agrirouter.technicalmessagetype.ISO11783_TaskData
...
|Protobuf Schema |agrirouter.technicalmessagetype.Timelog
...
The assignment of specific DDIs to groups can be found link:https://manual.agrirouter.com/en/manual/latest/appendix/ddis.html[here]
