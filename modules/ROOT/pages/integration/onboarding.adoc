...
[NOTE]
====
Before any data flow can happen, the very first command sent by the endpoint has to be the xref:endpoint.html#capabilities-command[Capabilities command].
====
