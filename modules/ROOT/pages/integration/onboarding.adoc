...
The external Id - to be seen in the <<Body Information>> of the onboarding request - needs to be a URN, which fits to the definitions in the xref:integration/general-conventions.adoc[general conventions].
