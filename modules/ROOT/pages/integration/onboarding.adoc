...
The registration code for a new CU can be created by the end user clicking "Onboard Telemetry Unit" in agrirouter's control center. He gets a 10-digit code consisting of letters and numbers. A CU needs an interface to input this registration code. Registration Codes are
