...
If the xref:./authorization.adoc[authorization process] is done using parameter _response_type=onboard_, the result will include a regcode. This regcode is a registration code.
