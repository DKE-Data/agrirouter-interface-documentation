...
For CUs, this requires additional infrastructure, therefore DKE advices to use the registration code exchange process.
...
image::./._images/ig2/image10.png[Application overview,636,361]


.Application settings
image::./._images/ig2/image11.png[Application settings,362,350]
...
image::./._images/ig2/image12.png[fuf.me is an alias for localhost,466,181]
...
image::./._images/ig2/image13.png[Authorization Workflow,619,376]
...
image::./._images/ig2/image14.png[Application authorization screen,252,202]
...
image::./._images/ig2/image15.png[Example of an authorization result,542,265]
...
image::./._images/ig1\image27.png[Authorization for non-cloud-applications,640,155]


[IMPORTANT]
====
Make sure, you save all the information returned from the authorization request, as you will e.g. need the account id for the xref:./revoke.adoc[Revoke functionality]!
====
