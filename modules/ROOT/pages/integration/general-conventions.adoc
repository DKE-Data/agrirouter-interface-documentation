...
Base64 as defined in link:https://tools.ietf.org/html/rfc4648[RFC4648] does *not* include line breaks. Make sure that your software creates Base64-Strings without line breaks.
