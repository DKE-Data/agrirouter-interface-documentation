...
[NOTE]
====
In the current release, `ENABLED` and `Enabled_ENABLED_HIGH_FREQUENCYHighSpeed` will result in the same behaviour directly delivering a message as a push notification.
