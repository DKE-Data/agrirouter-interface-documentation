...
[IMPORTANT]
====
agrirouter Marketplace is for the purpose of information for interested farmers or contractors only. DKE Data neither advises nor recommends the use of any of the listed solutions.
====
...
image::ig1/marketplace_telemetry_connections.png[my-agrirouter.com Marketplace,633,307]
