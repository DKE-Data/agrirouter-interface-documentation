...
Once you know which kind of application you want to create, you should get in contact with one of the link:https://my-agrirouter.com/support/certification[certification companies] *early on* to clarify which specific requirements you will have to fulfil to pass the certification.
