...
* xref:partner-process/legal-agreement.adoc[Step 1 - Legal Agreement]
* xref:partner-process/integration.adoc[Step 2 - Technical Integration]
* xref:partner-process/marketplace.adoc[Step 3 - Marketplace]
