...
The whole chapter can be found xref:./docs/general.adoc[here]
...
//About accounts
The whole chapter can be found xref:./docs/accounts.adoc[here]
...
//About applications
The whole chapter can be found xref:./docs/applications.adoc[here]
...
++++
<p align="center">
 <img src="./assets/images/ig1\image11.png" width="634px" height="400px">
</p>
++++
...
The whole chapter can be found xref:./docs/message_exchange.adoc[here]
...
The whole chapter can be found xref:./docs/messaging_workflow.adoc[here]
