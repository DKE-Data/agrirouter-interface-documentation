...
The whole chapter can be found link:./docs/message-exchange.adoc[here]
...
* The response for a request to the inbox buffer of a REST endpointwill be the information, that the command or message is being processed.
...
The whole chapter can be found link:./docs/messaging-workflow.adoc[here]
