...
This information must be created before going live under http://tptest.my-agrirouter.com/tptest/ in the content management test environment according DKE specifications. DKE quality management reviewes, approves and releases this information for go live.
