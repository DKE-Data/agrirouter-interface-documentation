...
After certification process is finalized, the "coming soon" label is removed and application or hardware provider is responsible for correctness and for keeping their solution information on the marketplace up to date. The login to the marketplace can be found link:https://my-agrirouter.com/en/interner bereich/my agrirouter/choose maintance/[here].
