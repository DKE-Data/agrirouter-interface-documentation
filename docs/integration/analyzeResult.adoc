...
The message_id is a unique ID of this message on the agrirouter. Use this id for the confirmation or delition request.
...
The agrirouter.commons.messages element includes a message as result of a command.
[source,javascript]
----
syntax = "proto3";
