...
The possible codes can be found in the xref:./../ErrorCodes.adoc[error code list], specific values will be described in more detail within the corresponding xref:./../commands/overview.adoc[Commands chapter].
