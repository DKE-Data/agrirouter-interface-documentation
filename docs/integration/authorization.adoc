...
The base URL can be found link:./../urls.adoc#AuthorizationURLs[here].
...
You **have to** use the key from link:../keys.adoc[Certificates and keys]!
====
...
[IMPORTANT]
====
Make sure, you save all the information returned from the authorization request, as you will e.g. need the account id for the link:./revoke.adoc[Revoke functionality]!
====
