...
The call for the authorization URL shall not time out. It shall display a page or redirect to a different page. HTTP Return codes indicating an error are not OK, given the onboarding itself worked.
