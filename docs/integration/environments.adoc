...
The required URLs can be found in link:./message-sending.adoc[message sending] and link:./authorization.adoc[authorization].
...
The number of endpoints in QA are limited to:
[width="100%" cols="3,1" header="true"]
|====
|Endpoint Type| Maximum

| Applications ( CUs / telemetry plattforms / Farming Software) | 200
| Machines | 300
| Virtual CU | 100
