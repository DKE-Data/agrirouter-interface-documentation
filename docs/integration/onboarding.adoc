...
The call for the authorization server URL shall not time out. Delivering a page or redirecting to a different URL is OK.
...
A valid URN shall be used to identify the new endpoint.
