...
Onboarding virtual CUs through a telemetry platform is done using a command. This is described in link:../tmt/cloud.adoc[Cloud solution commands].
...
A telemetry platform has to be onboarded using the authorization process. Once it is onboarded, it can onboard virtual CUs by itself. Therefore, it can use a special command. This is described in link:../tmt/cloud.adoc[Cloud solution commands].
...
|Quality Assurance |EU1 |: https://agrirouter-registration-service-hubqa-eu10.cfapps.eu10.hana.ondemand.com/[: https://agrirouter-registration-service-hubqa-eu10.cfapps.eu10.hana.ondemand.com/]
...
Possible ErrorMessages can be found link:../ErrorCodes.adoc[here].
