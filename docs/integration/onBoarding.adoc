...
image:ig2/image17.png[image,width=568,height=599]
...
image:ig2/image18.png[image,width=627,height=551]

Figure 13 onboarding Workflow for a farming software or telemetry platform

== Workflow for CUs

image:ig2/image19.png[image,width=627,height=311]
...
image:ig2/image20.png[image,width=642,height=368]

Figure 15 Requesting a registration code in agrirouter UI

image:ig2/image21.PNG[image,width=291,height=164]
...
image:ig2/image22.png[image,width=455,height=258]
...
image:ig2/image23.PNG[image,width=519,height=294]
...
image:ig2/image24.PNG[image,width=409,height=400]
