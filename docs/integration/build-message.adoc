...
Adding meta data is an optional feature since release of agrirouter version 1.2. Older systems might not interpret the information, however, they are still compatible.

*Important*
====
 In case of a chunked message, that shall include metadata, the *first* message shall include the meta data field.
====
