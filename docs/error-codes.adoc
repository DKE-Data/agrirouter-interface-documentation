...
| VAL_000025   | Unable to inboard machines as quota has been exceeded      |  	Machine onboarding through device description **(QA only)**	  | Error     | The new machine could not be added due to  too many machines in the account already.	                                     | ACK_WITH_FAILURE
...
| VAL_000307   | exceeded onboarding quota                          | VCU Onboarding    **(QA Only)**                    | Error     | VCu could not be onboarded due to too many VCUs already onboarded | ACK_WITH_MESSAGES
|===
