...
The agrirouter support team provides several contact possibilities. A contact field and further information can be found link:https://my-agrirouter.com/support/[here]. 

To get in contact with agrirouter support team, you can also send an email to support@my-agrirouter.com
...
DKE and other companies might offer trainings or workshops for onboarding and development of software for the agrirouter. To see a list of these workshops and trainings, see https://www.dke-data.com/category/news/. 

If there are no offers available and you feel like you might need one, don’t hesitate to send a request for training to info@dke-data.com.
