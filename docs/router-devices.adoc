...
[WARNING]
====
Everytime, the certificate is downloaded, it is updated in the agrirouters backend. So, make sure, you store the certificate in a secure place after you downloaded it and only click the download button again, when you want to update your certificate (see below).
====
