...
This is the certificationVersionId received when creating the application version.
...
If Message pushing is used in your software, please make sure you use "enabled" as long as you don't require a close-to-realtime delivery.
