...
The external Ids of the endpoints to be onboarded shall be in form of  URNs. They need to be unique.
See also the link:../integration/general-conventions.adoc[general conventions]
...
The Ids requested for offboarding need to be valid UUIDs.
