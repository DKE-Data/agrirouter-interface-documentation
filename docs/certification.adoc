...
* For some test case there has to be at last one extracted original message (as JSON or Base64-Encoded native Protobuf) has to be provided to the certification institute.
