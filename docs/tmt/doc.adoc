...
This format is used to exchange PDF documents. It can forward the binary PDF-Content, meta data like the flename can be forwarded using the metadata element in the request.
