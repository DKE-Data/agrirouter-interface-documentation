...
**Update**
As the payment concept changed to a flatrate model per sending directions (and of course per app instance), the statistics of who sent how much are not relevant for the billing anymore, but they list of endpoints and the accounts, they are assigned to helps to organize the billing process for the app provider.
