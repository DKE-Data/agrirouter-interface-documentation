...
image:ig2/image31.png[image,width=543,height=313]
...
image:ig2/image32.png[image,width=644,height=371]
...
image:ig2/image33.png[image,width=631,height=212]
...
image:ig2/image34.png[image,width=613,height=145]
...
image:ig2/image35.png[image,width=618,height=153]

Figure 30 Request and Response using MQTT

==== Communication with the Outbox

image:ig2/image36.png[image,width=633,height=151]
...
image:ig2/image39.png[image,width=512,height=210]

Figure 34 Send Message or Command to agrirouter

== Flow of commands

image:ig2/image40.png[image,width=482,height=290]
...
image:ig2/image41.png[image,width=575,height=348]
