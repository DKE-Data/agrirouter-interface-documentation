...
[IMPORTANT]
====
The certificate you receive during link:./integration/onboarding.adoc[onboarding] is valid for a certain period. The validity period can be found within the certificate itself. 
