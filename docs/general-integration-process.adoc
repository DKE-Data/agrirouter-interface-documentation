...
After the first contact with the company DKE-Data and signing the App- and Hardware Provider agreement, an agrirouter developer account can be created in the link:https://my-agrirouter.com/en/registration/[agrirouter quality assurance (QA) environment].
